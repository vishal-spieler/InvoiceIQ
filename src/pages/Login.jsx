      ...
      <div className="card col gap-6" style={{ 
        ...
        <div style={{ 
          ...
          <table style={{ width: '100%', fontSize: '11px', fontFamily: 'DM Mono', color: 'var(--t2)', marginBottom: '12px' }}>
            <tbody>
              <tr style={{ cursor: 'pointer' }} onClick={() => autofill('rahul@invoiceiq.io', 'owner123')} className="hover:bg-s3">
                <td style={{ padding: '2px 0', width: '120px' }}>rahul@invoiceiq.io</td>
                <td style={{ padding: '2px 0', color: 'var(--t3)' }}>/ owner123</td>
              </tr>
            </tbody>
          </table>
          ...
          <table style={{ width: '100%', fontSize: '11px', fontFamily: 'DM Mono', color: 'var(--t2)', marginBottom: '12px' }}>
            <tbody>
              <tr style={{ cursor: 'pointer' }} onClick={() => autofill('admin@tcs.com', 'tcs_admin')} className="hover:bg-s3">
                <td style={{ padding: '2px 0', width: '120px' }}>admin@tcs.com</td>
                <td style={{ padding: '2px 0', color: 'var(--t3)' }}>/ tcs_admin</td>
              </tr>
              <tr style={{ cursor: 'pointer' }} onClick={() => autofill('admin@infosys.com', 'inf_admin')} className="hover:bg-s3">
                <td style={{ padding: '2px 0', width: '120px' }}>admin@infosys.com</td>
                <td style={{ padding: '2px 0', color: 'var(--t3)' }}>/ inf_admin</td>
              </tr>
            </tbody>
          </table>
          ...
          <table style={{ width: '100%', fontSize: '11px', fontFamily: 'DM Mono', color: 'var(--t2)' }}>
            <tbody>
              <tr style={{ cursor: 'pointer' }} onClick={() => autofill('sneha@tcs.com', 'sneha123')} className="hover:bg-s3">
                <td style={{ padding: '2px 0', width: '120px' }}>sneha@tcs.com</td>
                <td style={{ padding: '2px 0', color: 'var(--t3)' }}>/ sneha123</td>
              </tr>
              <tr style={{ cursor: 'pointer' }} onClick={() => autofill('dev@tcs.com', 'dev123')} className="hover:bg-s3">
                <td style={{ padding: '2px 0', width: '120px' }}>dev@tcs.com</td>
                <td style={{ padding: '2px 0', color: 'var(--t3)' }}>/ dev123</td>
              </tr>
              <tr style={{ cursor: 'pointer' }} onClick={() => autofill('priya@infosys.com', 'priya123')} className="hover:bg-s3">
                <td style={{ padding: '2px 0', width: '120px' }}>priya@infosys.com</td>
                <td style={{ padding: '2px 0', color: 'var(--t3)' }}>/ priya123</td>
              </tr>
            </tbody>
          </table>
          <style>{`
